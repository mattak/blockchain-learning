...
class Blockchain(object):
    ...
    def proof_of_work(self, last_proof, difficulty=4):
        ...
        :param last_proof: <int> Last result of work
        :param difficulty: <int> Difficulty of proof of work. Range of 1 to 128. Bigger number is more difficult.
        :return: <int> Result number of proof of work
        """
    ...
    def resolve_conflicts(self):
        ...
        # Grab and verify the chians from all the nodes in our networks
    ...
    def valid_proof(last_proof, proof, difficulty):
        ...
        :param difficulty: <int> Calculation difficulty. 1 to 128 (sha512)
